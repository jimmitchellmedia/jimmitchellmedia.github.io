...
categories: [Apple, Apple Mail] # comma separated array
...
![Mail Folder](/assets/img/posts/mail-folder.png "Apple Mail Folder")
...
![Mail Import Message](/assets/img/posts/mail-import-message.png "Mail Import Message")
